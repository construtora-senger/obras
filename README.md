...
- A seção "Tradição de gerações" mostra as iniciais de cada um dentro de um quadro,
  no lugar das fotos. Quando os retratos existirem, é só trocar cada `<span class="retrato">`
  por uma imagem no mesmo espaço.
